...
- **Free vs. Premium** — **£15/month or £90/year (50% off yearly)**. Both plans get buddy matching, trainer session requests, workout logging, post-workout ratings, and progress posts. Premium adds phase-based matching, early/priority visibility into buddies and trainers, a 24-hour head start on requests, buddy accountability scores, city-wide gym challenges, early slot reservations, streak freezes, in-depth training analysis, and in-app nudges. See the comparison table in `index.html` (`#premium`) for the full feature-by-feature breakdown. Premium trainers get full client progress logging, in-depth graphical trend analysis, and the ability to post their own updates.
